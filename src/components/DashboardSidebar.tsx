...
const allSidebarItems: NavItem[] = [
  ...
  { icon: Layers, label: "Pensum", path: "/curriculum", roles: ["superadmin", "admin", "coordinator"] },
  { icon: BookOpen, label: "Materias / Secciones", path: "/courses", roles: ["superadmin", "admin", "teacher", "coordinator"] },
  { icon: Users, label: "Estudiantes", path: "/students", roles: ["superadmin", "admin", "teacher", "coordinator"] },
  { icon: CalendarDays, label: "Sesiones en Vivo", path: "/live-sessions", roles: ["superadmin", "admin", "teacher", "coordinator", "student"] },
  { icon: ClipboardList, label: "Evaluaciones", path: "/assessments", roles: ["superadmin", "admin", "teacher", "coordinator"] },
  { icon: Upload, label: "Entregas", path: "/submissions", roles: ["superadmin", "teacher", "coordinator", "student"] },
  { icon: BarChart3, label: "Cohorte de Notas", path: "/gradebook", roles: ["superadmin", "admin", "teacher", "coordinator"] },
